...
export const assessments: Assessment[] = [
  ...
  {
    title: "Create Your Personal DNA",
    description:
      "This is a set of questions designed to help you build a personal profile that you can give to an AI assistant so it truly knows you — your values, your communication style, your goals, and what drives you. The better AI knows you, the better it can serve you.",
    cta: "Build Your Personal DNA",
    type: "expandable",
    expandableContent: [
      "Your core values (top 5)",
      "Your behavioral style (DISC results if available)",
      "Your top motivators and what drives you",
      "Your communication preferences (how you like to receive information, how you make decisions)",
      "Your current role and professional context",
      "Your top 3 goals right now (personal and professional)",
      "Your strengths and known blind spots",
      "Your daily routine and non-negotiables",
      "The tone and style you want AI to use with you",
      "Any personal context that shapes how you think (faith, family, health, hobbies)",
    ],
  },
  {
